...
def configure():
    ...
    flags.DEFINE_integer("max_epoch", 50, "number of epochs for training")
    flags.DEFINE_integer("max_generated_imgs", 1, "max generated imgs for each input")
    flags.DEFINE_integer("max_test_epoch", 10, "number of epochs for testing; set equal to the number of samples in test set")
    ...
    flags.DEFINE_integer("checkpoint", 50, "number of epochs to be reloaded; set to 0 if training from scratch")
    flags.DEFINE_integer("height", 256, "height of image") #mod
    flags.DEFINE_integer("width", 256, "width of image") #mod
    flags.DEFINE_integer("slices", 64, "number of z slices") #mod
    flags.DEFINE_integer("train_range", 0, "number of samples for training; set to 0 if running independent test")
    ...
    flags.DEFINE_string("modeldir", 'ML_framework/checkpoint_Nucl', "the model directory where checkpoints are stored")
    ...
    flags.DEFINE_string("datadir", 'ML_framework/data/3d_fa_ind_test_nucl.h5', "the path to the HDF5 file containing the data")
